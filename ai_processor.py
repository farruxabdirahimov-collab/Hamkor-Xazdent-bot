...
async def make_card(product_data: dict) -> str:
    """Claude AI yordamida mahsulot kartochkasini tayyorlash"""
...
def format_full_card(raw: dict, ai: dict) -> str:
    """To'liq formatlangan kartochka (AI + raw ma'lumotlar)"""
